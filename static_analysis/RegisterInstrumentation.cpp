...
class RegisterPopSnippet : public Snippet {
  public:
   ...
   std::string fn;
    ...
    RegisterPopSnippet(std::string name) {
      fn = name;
    }
...
class RegisterPushSnippet : public Snippet {
  public:
    ...
    RegisterPushSnippet(std::string name) {
      fn = name;
    }
...
void handleInstruction(void *addr, Instruction::Ptr iptr, PatchBlock *block, PatchFunction *func) {
    ...
    if (id == e_ret_near) {
      ...
      Snippet::Ptr snippet = RegisterPopSnippet::create(new RegisterPopSnippet(""));
      ...
      Snippet::Ptr snippet = RegisterPushSnippet::create(new RegisterPushSnippet(""));
...
void handleFunction(BPatch_function *function, const char *name)
{
    ...
    */
    ...
    Snippet::Ptr snippet = RegisterPushSnippet::create(new RegisterPushSnippet(fn));
