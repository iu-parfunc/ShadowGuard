...
FIVE_REG_ARG_N_OFFST_FN(litecfi_register_peek)
...
ONE_REG_ARG_N_OFFSET_FN(litecfi_ctx_peek)
TWO_REG_ARG_N_OFFSET_FN(litecfi_ctx_peek)
THREE_REG_ARG_N_OFFSET_FN(litecfi_ctx_peek)
FOUR_REG_ARG_N_OFFSET_FN(litecfi_ctx_peek)
FIVE_REG_ARG_N_OFFST_FN(litecfi_ctx_peek)
SIX_REG_ARG_N_OFFSET_FN(litecfi_ctx_peek)
SEVEN_REG_ARG_N_OFFSET_FN(litecfi_ctx_peek)
EIGHT_REG_ARG_N_OFFSET_FN(litecfi_ctx_peek)
